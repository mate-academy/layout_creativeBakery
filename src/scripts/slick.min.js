!(function(i) {
  ...
  (e = (function() {
    ...
    }).find('a, input, button, select').attr({ tabindex: '-1' }), e.$dots !== null && (e.$slides.not(e.$slideTrack.find('.slick-cloned')).each(function(t) {
      const s = o.indexOf(t);
    ...
    o = s.slideCount - s.options.slidesToShow, !s.options.infinite && s.currentSlide > o && (s.currentSlide = o), s.slideCount <= s.options.slidesToShow && (s.currentSlide = 0), t = s.currentSlide, s.destroy(!0), i.extend(s, s.initials, { currentSlide: t }), s.init(), e || s.changeSlide({ data: {
